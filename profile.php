...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,CNIC=:cnic,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
$query = $dbh->prepare($sql);
$query->bindParam(':name',$name,PDO::PARAM_STR);
$query->bindParam(':mobileno',$mobileno,PDO::PARAM_STR);
$query->bindParam(':cnic',$mobileno,PDO::PARAM_STR);
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/logo3.jpg" alt="image">
      </div>
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           ...
           <div class="form-group">
              ...
              <input class="form-control white_bg" name="CNIC" value="<?php echo htmlentities($result->CNIC);?>" id="CNIC" type="text" required>
            </div>
